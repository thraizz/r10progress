      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          ...
          <div className="hidden sm:block">
            <div className="fixed bottom-0 left-0 right-0 flex transform flex-col items-end justify-center gap-4 bg-white p-6 shadow-lg transition-all">
              <div className="flex w-full items-center justify-between gap-8">
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    We use Mouseflow to analyze how visitors use our site. This
                    helps us improve the user experience. The tracking is
